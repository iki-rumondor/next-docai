'use client';
import { LayoutDashboard, Upload, Cpu, FileText, Settings, LogOut, User } from "lucide-react";
            ...
            <div className="mx-auto max-w-7xl">
                <nav className="bg-nav rounded-2xl shadow-elevated border border-border/40 px-3 py-2 flex items-center">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-foreground tracking-tight hidden sm:inline">DocAI</span>
                    </div>
