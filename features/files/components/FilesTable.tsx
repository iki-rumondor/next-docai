            ...
            <Table>
                ...
                <TableBody>
                    {jobs.map((job, idx) => (
                        ...
                        >
                            <TableCell className="font-medium text-[13px] max-w-55 truncate py-4">{job.file_name}</TableCell>
                            <TableCell className="text-[13px] text-muted-foreground py-4">{job.page_count}</TableCell>
                            ...
                            <TableCell className="text-[13px] text-muted-foreground py-4">{job.created_at}</TableCell>
